                ...
                <Col xs={12} md={12} xl={12}>
                    ...
                    <div className="row" id="services-panels">
                        ...
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="panel-heading">PROJECT MANAGEMENT ​AND CO-ORDINATION</div>
                        ...
                        {/** Panel 3 */}
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="panel-heading">GEOTECHNICAL ​ENGINEERING</div>
                            <div class="panel-body">
                                <ul>
                        ...
                        {/** Panel 4 */}
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="panel-heading">TOWN AND REGIONAL ​PLANNING</div>
                            <div class="panel-body">
                                <ul>
                        ...
                        {/** Panel 5 */}
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="panel-heading">BENEFICIARY ADMINISTRATION ​AND VERIFICATION</div>
                            <div class="panel-body">
                                <ul>
                        ...
                        {/** Panel 6 */}
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="panel-heading">QUANTITY SURVEYING</div>
                            <div class="panel-body">
                                <ul>
                        ...
                        {/** Panel 7 */}
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="panel-heading">LAND SURVEYING</div>
                            <div class="panel-body">
                                <ul>
                        ...
                        {/** Panel 8 */}
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="panel-heading">ENVIROMENTAL ​MANAGEMENT</div>
                            <div class="panel-body">
                                <ul>
                        ...
                        {/** Panel 9 */}
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="panel-heading">Township Registrations</div>
                            <div class="panel-body">
                                <ul>
                        ...
                        <div class="panel panel-default col-lg-4 col-md-6 col-sm-12 col-xs-12 align-item-center">
                            <div class="panel-heading">ARCHITECTURAL AND URBAN DESIGNS</div>
                            <div class="panel-body">
                                <ul>
